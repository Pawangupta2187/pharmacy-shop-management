...
$id=$_GET['Emp_id'];
$query = "SELECT * FROM employees where Emp_id=$id";  // query to search users from Table,access existing information for updation
...
$sql="update employees set Emp_name='$ename',Emp_gender='$gender',Emp_adhar='$acard',Emp_mail='$email',Emp_designation='$designation',Emp_address='$address',Salary='$salary',Duty_hours='$duty',Contact_no= '$contact' where Emp_id=$id";
...
Edit Your Profile!&nbsp;&nbsp;<?php echo "Your id:-".$id ?>
</div>
...
else if(!(confirm("Conifirm Details!")))
{
  return false;
}else{
  return true;
